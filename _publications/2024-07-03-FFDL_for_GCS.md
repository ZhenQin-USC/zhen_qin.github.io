...
<div style='text-align: center;'>
  ...
  <img src='/files/WRR2025_FFDL/Figure2.jpg' alt='FFDL Model 2' width='500' height='auto' style='margin: 10px;'>
</div>"
...
<details>
  <summary style="border: 1px solid #ccc; padding: 10px; cursor: pointer;">
    <b>Plain Language Summary:</b> (Click to Expand)
  </summary>
...
<details>
  <summary style="border: 1px solid #ccc; padding: 10px; cursor: pointer;">
    <b>Recommended Citation:</b> (Click to Expand)
  </summary>
